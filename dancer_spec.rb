...
describe Dancer do
  ...
  it "changes tutu color" do
    dancer.tutu = "purple"
    expect(dancer.tutu).to eq "purple"
  end

  it "caps dance queue at 10" do
    10.times do |i|
      dancer.queue_dance_with("#{i} dancer")
    end
    expect(dancer.queue_dance_with('jess')).to eq "The dance queue is full."
  end
